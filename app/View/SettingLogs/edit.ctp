...
<?php echo $this->Form->create('SettingLog');?>
	<fieldset>
	<legend><?php echo __('Edit Setting Log'); ?></legend>
		<?php
...
<?php $this->start('sidebar'); ?>	<div class="sidebar well">
		...
		<li><?php echo $this->Form->postLink($this->TwitterBootstrap->icon('trash', 'black') .' '.__('Delete'), array('action' => 'delete', $this->Form->value('SettingLog.id')), array('escape'=>false), __('Are you sure you want to delete # %s?', $this->Form->value('SettingLog.id'))); ?></li>
